...
# 6th National Action Plan on Open Government Tracker / Outil de suivi pour le 6ᵉ Plan d'action national pour un gouvernement ouvert

**Dataset Type:** `nap6`  
**Last Generated:** 2026-07-19T02:35:53 (UTC)  
**Source:** dictionaries/nap6.json  
**Commit:** `27ff5a1`
...
- [6th National Action Plan on Open Government Tracker / Outil de suivi pour le 6ᵉ Plan d'action national pour un gouvernement ouvert](#nap6)
...
| `commitments` | Commitments / Engagements | `text` | Yes |  | commitments | The 4 commitments in the 2025-2029 National Action Plan on Open Government |
...
| `progress_en` | Progress during reporting period (English) / Progrès au cours du  période de déclaration (anglais) | `text` | Yes |  |  | 1-3 bullets outlining progress made during the most recent reportnig period. If… |
| `progress_fr` | Progress during reporting period (French) / Progrès au cours du période de déclaration (français) | `text` | Yes |  |  | 1-3 bullets outlining progress made during the most recent reporting period. If… |
...
| `challenges_en` | Challenges (English) / Défis (anglais) | `text` | No |  |  | Describe any challenges faced, in English |
| `challenges_fr` | Challenges (French) / Défis (français) | `text` | No |  |  | Describe any challenges faced, in French |
...
**Type:** `text`  
**Required:** Yes  
**Choice Set:** reporting_period (9 values)  
...
**Type:** `text`  
**Required:** Yes  
**Choice Set:** commitments (4 values)  


**Description:**  
EN: The 4 commitments in the 2025-2029 National Action Plan on Open Government  
FR: Les 4 engagements dans le Plan d'action national du Canada pour un gouvernement ouvert de 2025-2029


##### Allowed Values (commitments)
...
**Type:** `text`  
**Required:** Yes  
**Choice Set:** milestones (19 values)  
...
| `C02.2` | Improve the effectiveness of the Digital Citizen Initiative | Accroître l&#39;efficacité de l&#39;Initiative de citoyenneté numérique. |
...
| `C04.3` | Monitor Canadians&#39; experiences with serious legal problems and enhance the Department of Justice Canada&#39;s understanding of effective responses using findings from the National Justice Survey and Serious Legal Problems in Canada
...
Utiliser les données du Sondage national sur la justice pour éclairer le processus décisionnel du ministère de la Justice Canada et des principaux intervenants externes.
 |
| `C04.4` | Update Justice Canada&#39;s State of the Criminal Justice System Dashboard and pursue the automation of updates to support easier dissemination of data to the public.
...
Explore, in collaboration with key partners, the possibility of expanding the indicators in the Department of Justice Canada&#39;s State of the Criminal Justice System dashboard to include available disaggregated data related to court delays and other key justice system issues.
 | Mettre à jour le Tableau de bord sur l&#39;état du système de justice pénale du ministère de la Justice Canada et automatiser les mises à jour pour faciliter la diffusion des données au public.
...
**Type:** `text`  
**Required:** Yes  
**Choice Set:** indicators (65 values)  
...
#### `progress_en` – Progress during reporting period (English) / Progrès au cours du  période de déclaration (anglais)
...
**Description:**  
EN: 1-3 bullets outlining progress made during the most recent reportnig period. If no progress has been made, please write "NIL"  
FR: 1-3 balles décrivant les progrès réalisés au cours dupériode de déclaration. Si aucun progrès n'a été réalisé, veuillez écrire "NIL"


---

#### `progress_fr` – Progress during reporting period (French) / Progrès au cours du période de déclaration (français)
...
**Description:**  
EN: 1-3 bullets outlining progress made during the most recent reporting period. If no progress has been made, please write "NUL"  
FR: 1-3 balles décrivant les progrès réalisés au cours du dernier période de déclaration. Si aucun progrès n'a été réalisé, veuillez écrire "NUL"
...
**Type:** `text`  
**Required:** No  
**Validation:** Required if "Status" is "Limited progress" or "Not started" / Obligatoire si « État » est « Progrès limité » ou « Pas commencé ».  


**Description:**  
EN: Describe any challenges faced, in English  
FR: Décrivez les défis rencontrés en anglais
...
**Description:**  
EN: Describe any challenges faced, in French  
FR: Décrivez les défis rencontrés en français
...
- Generated: 2026-07-19T02:35:53 (UTC)
- Source: dictionaries/nap6.json
- Commit: `27ff5a1`
